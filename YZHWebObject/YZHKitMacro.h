...
#define SYNC_LOCK(LOCK,...)         dispatch_semaphore_wait(LOCK, DISPATCH_TIME_FOREVER) \
                                    __VA_ARGS__; \
                                    dispatch_semaphore_signal(LOCK);


static inline void dispatch_safe_in_queue(dispatch_queue_t queue,void (^block)(void)) {
